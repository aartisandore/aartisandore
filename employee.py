...
class employeeClass:
    def __init__(self, root):
        ...
        #===options===
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_Search_by,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_search.place(x=10,y=10,width=180)
        cmb_search.current(0)

        txt_search=Entry(SearchFrame,textvariable=self.var_search_txt,font=("goudy oldsd style",15),bg="lightyellow").place(x=200,y=10)
        btn_search=Button(SearchFrame,text="Search",font=("goudy oldsd style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)
      ...
      #===row3===
        ...
        txt_salery=Entry(self.root,textvariable=self.var_salery,font=("goudy old style",15),bg="lightyellow").place(x=600,y=270,width=180)

      #===buttons====
        btn_add=Button(self.root,text="Save",font=("goudy oldsd style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",font=("goudy oldsd style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=620,y=305,width=110,height=28)
     ...
     #====Employee Details===
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","email","gender","contact","dob","doj","pass","utype","address","salery"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.EmployeeTable.heading("salery",text="Salary")
        ...
        self.EmployeeTable.column("salery",width=200)
