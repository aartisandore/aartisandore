...
class salesClass:
    def __init__(self, root):
        ...
        # =====title============
        lbl_title = Label(self.root, text=" View Customer Bill ", font=("gowdy old style", 30), bg="#184a45", fg="white", bd=3, relief=RIDGE).pack(side=TOP, fill=X, padx=10, pady=2)
        ...
        self.sales_list = Listbox(sales_Frame, font=("gowdy old style", 15), bg="white", yscrollcommand=scrolly.set)
        ...
        lbl_title2= Label(bill_Frame, text=" Customer Bill Area", font=("gowdy old style", 30), bg="orange").pack(side=TOP, fill=X)


        scrolly2=Scrollbar(bill_Frame,orient=VERTICAL)
        self.bill_area=Text(bill_Frame,font=("gowdy old style",15),bg="lightyellow",yscrollcommand=scrolly2.set)
